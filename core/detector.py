...
Uses YOLOv8 to detect vehicles and pedestrians in frames.
"""
...
# Custom model class IDs — 18-class model (vehicles + collision types)
VEHICLE_CLASSES = {
    0:  "bicycle",
    1:  "motorcycle",
    2:  "auto-rickshaw",
    ...
    10: "motorcycle-car_collision",
    11: "motorcycle-person_collision",
...
class VehicleDetector:
    ...
    def detect(self, frame: np.ndarray) -> List[Detection]:
        results = self.model(
            frame,
            conf=self.conf,
            imgsz=480,      # smaller = faster inference on CPU
            verbose=False,
        )[0]
        ...
        for box in results.boxes:
            ...
            det = Detection(
                ...
                color=VEHICLE_COLORS.get(name, (128, 128, 128)),
            )
